                        ...
                        <table>
                            ...
                            <tbody>
                                ...
                                foreach($getCartData as $i):
                                    if($i['keranjang_ukuran']=='m2'){
                                        $subtotal=($i['produk_harga']-($i['produk_harga']*15/100))*$i['keranjang_qty'];
                                        $subdsc=(($i['produk_harga']*15)/100)*$i['keranjang_qty'];
                                        $subongkir=0*$i['keranjang_qty'];
                                    }else {
                                        $subongkir=10000*$i['keranjang_qty'];
                                        if($i['keranjang_qty']>=3){
                                            $subtotal=($i['produk_harga']-($i['produk_harga']*5/100))*$i['keranjang_qty'];
                                            $subtqty=(($i['produk_harga']*5)/100)*$i['keranjang_qty'];
                                        }else{
                                    ...
                                    <tr>
                                        ...
                                        <td><?php if($i['keranjang_ukuran']=='m1'){ echo "1 Papan";} else { echo "2 Papan";}?></td>
                                        <td class="product-price-cart">
                                            <?php 
                                            if($i['keranjang_ukuran']=='m2'){
                                                $pharga=($i['produk_harga']-($i['produk_harga']*15/100));
                                                ?>
                                                <span class="amount">
                                                ...
                                                if($i['keranjang_qty']>=3){
                                                    $pharga=($i['produk_harga']-($i['produk_harga']*5/100));
                                                    ?>
                                                    <span class="amount">
                                                        <?= "Rp. ".number_format($pharga); ?>
                                                    </span>

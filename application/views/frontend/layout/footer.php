                            ...
                            <div class="col-lg-7 col-md-7 col-sm-12">
                                <div class="modal_right">
                                    ...
                                    <div class="modal_price mb-10">
                                        ...
                                        $promo = $this->Mymod->GetDataJoinNW($jtable)->num_rows();
                                        $kk = $this->Mymod->GetDataJoinNW($jtable)->row_array();

                                        if($promo>0){
                                            ?>
                                            <span class="new_price" >
                                                <?= "Rp. ".number_format($i['produk_harga']-(($i['produk_harga']*$kk['promo_diskon'])/100)); ?>
                                            </span>   
